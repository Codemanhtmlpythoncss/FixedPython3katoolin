...
0) All
        ...
        match opcion1:
            ...
            case "10":
                install_stress_testing()
            case "11":
                install_password_attacks()
            case "12":
                install_reverse_engineering()
            case "13":
                install_hardware_hacking()
            case "14":
                install_extra()
            case _:
                print("\033[1;31mSorry, that was an invalid command!\033[1;m")

def install_information_gathering():
    print('''
...
def install_vulnerability_analysis():
    print('''
...
def install_maintaining_access():
    print('''
...
def install_exploitation_tools():
    print('''
